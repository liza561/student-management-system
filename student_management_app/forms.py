...
class ChoiceNoValidation(forms.ChoiceField):
...
class AddStudentForm(forms.Form):
    ...
    try:
        ...
        for ses in sessions:
            small_ses=(ses.id,str(ses.sessions_start_year)+" TO "+str(ses.sessions_end_year))
...
class EditResultForm(forms.Form):
    ...
    try:
        sessions=SessionYearModel.objects.all()
        for ses in sessions:
            session_single=(ses.id,str(ses.sessions_start_year)+" TO "+str(ses.sessions_end_year))
