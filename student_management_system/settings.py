...
SECRET_KEY = 'django-insecure-$v3orbf3-xl-k=bv@#)i_o(ln!hvl+na-46&k%bfm=$!7yh^dg'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR /"student_management_system" / "templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
FIREBASE_PROJECT_ID = "student-1067a"
...
#     'student_management_app.emailbackend.EmailBackend',  # your custom backend
